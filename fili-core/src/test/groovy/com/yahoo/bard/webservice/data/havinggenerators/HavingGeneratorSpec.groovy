...
import com.yahoo.bard.webservice.web.apirequest.generator.having.DigitsHavingGenerator
...
class HavingGeneratorSpec extends Specification {
    ...
    def "check parsing generateHavings for one metric"() {
        ...
        when:
        Map<LogicalMetric, Set<ApiHaving>> generateHaving =  new DigitsHavingGenerator(loader).apply(query, logicalMetrics);
    ...
    def "Bad having query #having throws #exception.simpleName because #reason"() {
        ...
        when:
        DigitsHavingGenerator digitsHavingGenerator = new DigitsHavingGenerator(loader);
