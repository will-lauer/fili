...
["description":"The pets all grain", 
    "dimensions":[
        ["category": "General", "name": "breed",   "longName": "breed",   "uri": "http://localhost:9998/v1/breed",   "cardinality": 0, "fields": ["id", "desc"]], 
        ["category": "General", "name": "sex",     "longName": "sex",     "uri": "http://localhost:9998/v1/sex",     "cardinality": 0, "fields": ["id", "desc"]], 
        ["category": "General", "name": "species", "longName": "species", "uri": "http://localhost:9998/v1/species", "cardinality": 0, "fields": ["id", "desc"]]
        ], 
    "longName": "All", 
    "metrics": [
        ["category": "General", "name": "rowNum",      "longName": "rowNum",      "uri": "http://localhost:9998/v1/rowNum"], 
        ["category": "General", "name": "limbs",       "longName": "limbs",       "uri": "http://localhost:9998/v1/limbs"],
        ["category": "General", "name": "dayAvgLimbs", "longName": "dayAvgLimbs", "uri": "http://localhost:9998/v1/dayAvgLimbs"]
    ], 
    "name": "all", 
    "retention": "P1Y"
]
"""
        ...
        JsonNode expected = reader.readValue(expectedResponse)
        ...
        JsonNode actual = reader.readValue(mapper.writer().writeValueAsString(tableGrainView));
        then:
        expected == actual
#        tableGrainView.sort().toString() == expectedResponse
    ...
    public ArrayList<TableView> getExpectedOutput(Set<LogicalTable> petsTables) {
        ...
        tableView.put("storageStrategy", "loaded")
