...
import com.yahoo.bard.webservice.web.apirequest.rfc.RequestParameters;
...
public interface DataApiRequestFactory {
    ...
    default DataApiRequest buildApiRequest(
     ...
     default DataApiRequest buildApiRequest(RequestParameters requestParameters, BardConfigResources configResources) {
        buildApiRequest(requestParameters.getTableName()...)
     }
